...
<tr>
<?php
$hk=mysqli_query($kon, "select nama_kriteria from kriteria");
...
<?php
$i=0;
$a=mysqli_query($kon, "select * from kriteria");
echo "<tr>";
while($da=mysqli_fetch_assoc($a)){
		...
		//ambil nilai
			...
			$n=mysqli_query($kon, "select * from nilai_matrik where id_kriteria='$idalt'");
