...
$i3=0;
$maxarray=array();
$a2=mysqli_query($kon, "select * from kriteria");
echo "<tr>";
while($da2=mysqli_fetch_assoc($a2)){
		...
		//ambil nilai
			...
			$n2=mysqli_query($kon, "select * from nilai_matrik where id_kriteria='$idalt2'");
		$jarakp2=0;
		$c2=0;
		$ymax2=array();
		...
		while($dn2=mysqli_fetch_assoc($n2)){
			...
			$k22=mysqli_query($kon, "select * from nilai_matrik where id_kriteria='$idk2' ");
			...
			//nilai bobot input
			$b2=mysqli_query($kon, "select * from kriteria where id_kriteria='$idk2'");
